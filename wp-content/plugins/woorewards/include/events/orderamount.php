...
class OrderAmount extends \LWS\WOOREWARDS\Abstracts\Event
{
	function getInformation()
	{
		return array_merge(parent::getInformation(), array(
			...
			'help'  => __("Most used method on WooRewards. Lots of options", 'woorewards-lite'),
		));
	}
	...
	function getForm($context='editlist')
	{
		...
		$label = sprintf(_x("Money spent (%s)", "Order Amount Event money diviser", 'woorewards-lite'), \LWS_WooRewards::isWC() ? \get_woocommerce_currency_symbol() : '?');
...
EOT;
	...
	{
		return $order->get_customer_id('edit');
	}

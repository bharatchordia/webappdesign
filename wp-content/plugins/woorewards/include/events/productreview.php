...
class ProductReview extends \LWS\WOOREWARDS\Abstracts\Event
{
	...
	function getForm($context='editlist')
	{
		...
		$form .= $this->getFieldsetBegin(2, __("Options", 'woorewards-lite'), 'col50');
		...
		$form .= "<div class='lws-$context-opt-input value'><input type='checkbox'$checked id='{$prefix}purchase_required' name='{$prefix}purchase_required' class='lws_checkbox'/></div>";
...
EOT;
	...
	public function getCategories()
	{
		return array_merge(parent::getCategories(), array(
			...
			'product'  => __("Product", 'woorewards-lite')
		));
	}
}

...
class UnlockableList extends \LWS\WOOREWARDS\Ui\Editlists\MultiFormList
{
	...
	static function getChoiceCategories()
	{
		...
		return \apply_filters('lws_woorewards_system_item_type_groups', array(
			'shop_coupon'      => array('label' => _x("Coupons", "Option Group", 'woorewards-lite'), 'color' => '#cc1d25', 'icon' => $dftIcon),
			'wp_user'          => array('label' => _x("User's status", "Option Group", 'woorewards-lite'), 'color' => '#0136a7', 'icon' => $dftIcon),
			...
			''                 => array('label' => _x("Miscellaneous", "Option Group", 'woorewards-lite'), 'color' => '#7801a7', 'icon' => false),
		), 'unlockable');
	}

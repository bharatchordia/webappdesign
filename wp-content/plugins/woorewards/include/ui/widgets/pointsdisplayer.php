...
class PointsDisplayer extends \LWS\WOOREWARDS\Ui\Widgets\Widget
{
	...
	public function __construct($asWidget = true)
	{
		if( $asWidget )
		{
			parent::__construct(
				...
				__("WooRewards Points Displayer", 'woorewards-lite'),
				array(
	 ...
	 *	WooRewards Standard : Automatically display the prefab pool points
	 *	WooRewards Pro : Display points for the selected pool or stack
	 *	@code
	...
	{
		if( !empty($userId = \get_current_user_id()) || isset($this->stygen) )
		{

...
The plugin extends the product options with extra fields. It allows customers to configure the product using texts, numbers, dropdowns and multi-dropdowns, radio buttons and checkboxes.
...
[>>> Go to the FPF demo <<<](https://demo.wpdesk.org/?utm_source=wpdesk&utm_medium=demo-link&utm_campaign=demo-flexible-product-fields-pro-woocommerce)
...
* [Date](https://www.wpdesk.net/docs/flexible-product-fields-woocommerce-docs/#Date_Picker)

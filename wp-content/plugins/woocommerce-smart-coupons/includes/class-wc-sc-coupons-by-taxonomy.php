	...
	class WC_SC_Coupons_By_Taxonomy {
		...
		public function get_default_taxonomy_restriction_row() {
			...
			<p class="form-field">
				...
				<button type="button" id="wc_sc_add_taxonomy_row" class="button wc_sc_add_taxonomy_row" title="<?php echo esc_attr__( 'Add taxonomy restriction', 'woocommerce-smart-coupons' ); ?>"><?php echo esc_html__( 'Add taxonomy restriction', 'woocommerce-smart-coupons' ); ?></button>
			</p>
			<?php
		}
			...
			?>
				<p class="form-field wc_sc_taxonomy_restrictions_row wc_sc_taxonomy_restrictions-<?php echo esc_attr( $index ); ?>">
					...
					<?php
						...
						$this->get_taxonomy_restriction_select_tag( $args );
						?>
					<button type="button" id="wc_sc_add_taxonomy_row" class="button wc_sc_add_taxonomy_row" title="<?php echo esc_attr__( 'Add taxonomy restriction', 'woocommerce-smart-coupons' ); ?>"><span class="dashicons dashicons-plus-alt2"></span></button><button type="button" id="remove_wc_sc_taxonomy_restrictions-<?php echo esc_attr( $index ); ?>" class="button remove_wc_sc_taxonomy_restrictions-<?php echo esc_attr( $index ); ?>" title="<?php echo esc_attr__( 'Remove taxonomy restriction', 'woocommerce-smart-coupons' ); ?>"><span class="dashicons dashicons-no-alt"></span></button>
				</p>
			<?php
		}
		...
		public function styles_and_scripts() {
			...
			<style type="text/css">
				...
				.options_group.wc_sc_taxonomy_restrictions .dashicons.dashicons-plus-alt2::before {

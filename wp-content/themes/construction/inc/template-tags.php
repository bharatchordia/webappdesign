...
function wpcharming_get_page_header($postID) {
	...
	if ( $enable_page_header == 'on' ) {
		...
		<div class="page-header-wrap clearfix '. $wpc_row_parallax .'"'. $page_header_style . $data_bg .'>
			...
			echo wp_kses_post( $parallax_bg );

			echo wp_kses_post( $parallax_overlay );
	...
	if ( $hide_page_title != 'on' ) {
		...
		<div class="page-title-wrap <?php if ( $display ) echo 'page-title-has-button'; ?>">
			<div class="container">
				...
				<?php
				if ( $display ) echo wp_kses_post( $button );
				?>
			</div>
		</div>
		<?php
...
function wpcharming_custom_css() {
	...
	if ( !empty( $custom_css ) ) echo ent2ncr($css_output);
...
function wpcharming_header_code() {
	...
	if ( $site_header_tracking !== '' ) echo balanceTags($site_header_tracking, true);
}
...
function wpcharming_footer_code() {
	...
	if ( $site_footer_tracking !== '' ) echo balanceTags($site_footer_tracking, true);
}

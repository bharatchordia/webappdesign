...
function wpcharming_scripts() {
	...
	wp_enqueue_style( 'wpcharming-fontawesome', get_template_directory_uri() .'/assets/css/font-awesome.min.css', array(), '4.4.0' );
	if ( is_rtl() ){
	...
	wp_localize_script('wpcharming-theme','header_fixed_setting', $is_fixed_header);
...
function misha_total_sales_1( $col_th ) {
	...
	return wp_parse_args( array( 'total_sales' => 'Total Order' ), $col_th );
